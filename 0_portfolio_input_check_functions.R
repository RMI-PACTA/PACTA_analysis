...
get_and_clean_fin_data <- function(fund_data){
  ...
  # Financial Data
  fin_data_raw <- read_in_file(paste0(analysis_inputs_path,"/security_financial_data.rda")) %>% as_tibble()
...
get_average_emission_data <- function(inc_emission_factors){
  ...
  if(inc_emission_factors){
    ...
    average_sector_intensity <- read_in_file(paste0(analysis_inputs_path,"average_sector_intensity.rda"))
  }
...
get_company_emission_data <- function(inc_emission_factors){
  ...
  if(inc_emission_factors){
    ...
    company_emissions <- read_in_file(paste0(analysis_inputs_path,"company_emissions.rda"))
  }
