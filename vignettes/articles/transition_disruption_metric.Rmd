...
There are several metrics included in the PACTA analysis. Some metrics offer interesting insights on short time-scales (ie. 5 years into the future). However, analysts may also be interested in longer-term insights, ranging on time scales from 10-20 years into the future. Here we will propose and derive one of these metrics, called the Transition Disruption Metric. 
