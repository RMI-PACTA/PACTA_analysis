test_that("`calculate_fund_portfolio()` works as expected", {
  ...
  fund_portfolio <-
    tibble::tribble(
      ...
      "IE00B9346255", 500,           "USD",     "TestPortfolio", "Test",         "58",        NA_real_,          1,              500,        28581,       "Institutional Cash Series Plc", 34841267,      NA,                     "IE",                 121.4076252,       1.2253,             "Funds",     "Open-End Funds", "Other",                 NA,                      "Unclassified",          NA,           NA,             NA,            NA,             NA,                                      FALSE,            "Other",     NA,             "Other",     NA,          NA,             FALSE
    )
  fund_data <-
    tibble::tribble(
