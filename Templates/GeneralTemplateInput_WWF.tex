...
%	%
%	\section*{} 
%	\HeaderDouble{EXECUTIVE SUMMARY}{TRANSITION RISK EXPOSURE}
%	
%	\begin{multicols}{2}
%		
%		This scenario analysis presents the magnitude of the current exposure to each technology in Startyear. The exposure is the aggregated weight of each technology from each issuer currently in the portfolio. The is compared to the aggregated weight of each technology for all issuers in the corporate bond and/or equity market. 
%		
%		This informs on what portion of your portfolio is exposed to sectors and technologies exposed to climate transition risk, and how this compares to the relevant market.  
%
%	\end{multicols}
%
%	%CBSpecificS
...
%	%CBSpecificS
%	\section*{}  
%	\HeaderDouble{EXECUTIVE SUMMARY}{CORPORATE BOND PORTFOLIO ALIGNMENT}
%	
%	\begin{multicols}{2}
%	
%		Of the exposure of the corporate bond portfolio to these sectors, the alignment of each technology with the market under the ScenarioValue shows the extent to which the portfolio would be over or underexposed to risk, if this scenario were to materialise. 
%		
%%		For sectors such as power where lower carbon alternatives exist and the sector is not expected to decrease in size, the alignment metric shown below is the percentage difference in the share of the technology within the sector in your portfolio, compared to the corporate bond market aligned to the ScenarioValue in Startyear+5. A positive value for renewable power indicates the share of renewable capacity of the total power capacity is expected to be greater than the aligned market. A positive value for coal power indicates the share of coal capacity is greater than what is expected in an aligned market. 
%%		
%%		For sectors such as oil, gas and coal production where no lower carbon alternatives exist and the sector is expected to decrease in size, the alignment metric shows the difference in the production of the technology allocated to the portfolio compared to the corporate bond market, scaled down by AUM value of the portfolio, aligned to the ScenarioValue in Startyear+5. A positive value for coal production indicates the portfolio has a greater production than allowed under an aligned market. 
%		
%		The alignment of the renewable capacity, coal capacity and coal production of the corporate bond portfolio with the ScenarioValue in Startyear+5 is shown below in comparison to the peers. 
%
%	
%	\end{multicols}	
%	
%	
%	\textbf{Renewable Capacity}
%	
%	\includegraphics[trim = {0 0cm 0 0cm},width=1\linewidth]{ReportOutputs/Fig83}
%
%	\textbf{Coal Capacity}
%	
%	\includegraphics[trim = {0 0cm 0 0cm},width=1\linewidth]{ReportOutputs/Fig84}	
%		
%	\textbf{Coal Production}
%	
%	\includegraphics[trim = {0 0cm 0 0cm},width=1\linewidth]{ReportOutputs/Fig85}
%
%	\newpage 
%	%CBSpecificE
%	%EQSpecificS
%	\section*{}  
%	\HeaderDouble{EXECUTIVE SUMMARY}{EQUITY PORTFOLIO ALIGNMENT}
%	
%	\begin{multicols}{2}
%		
%		Of the exposure of the equity portfolio to these sectors, the alignment of each technology with the market under the ScenarioValue shows the extent to which the portfolio would be over or underexposed to risk, if this scenario were to materialise. 
%		
%%		For sectors such as power where lower carbon alternatives exist and the sector is not expected to decrease in size, the alignment metric shown below is the percentage difference in the share of the technology within the sector in the equity portfolio, compared to the equity market aligned to the ScenarioValue in Startyear+5. A positive value for renewable power indicates the share of renewable capacity of the total power capacity is expected to be greater than the aligned market. A positive value for coal power indicates the share of coal capacity is greater than what is expected in an aligned market. 
%%		
%%		For sectors such as oil, gas and coal production where no lower carbon alternatives exist and the sector is expected to decrease in size, the alignment metric shows the difference in the production of the technology allocated to the equity portfolio compared to the equity market, scaled down by AUM value of the portfolio, aligned to the ScenarioValue in Startyear+5. A positive value for coal production indicates the portfolio has a greater production than allowed under an aligned market. 
%		
%		The alignment of the renewable capacity, coal capacity and coal production of the equity portfolio with the ScenarioValue in Startyear+5 is shown below in comparison to the peers. 
%		
%		
%	\end{multicols}	
%	
...
%	\textbf{Renewable Capacity}
%	
%	\includegraphics[trim = {0 0cm 0 0cm},width=1\linewidth]{ReportOutputs/Fig80}
%	
%	\textbf{Coal Capacity}
%	
%	\includegraphics[trim = {0 0cm 0 0cm},width=1\linewidth]{ReportOutputs/Fig81}	
%	
%	\textbf{Coal Production}
%	
%	\includegraphics[trim = {0 0cm 0 0cm},width=1\linewidth]{ReportOutputs/Fig82}
%	
%	\newpage 
%	%EQSpecificE
