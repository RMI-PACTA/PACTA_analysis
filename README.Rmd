...
Finally you need access to the PACTA siblings. You can create one or more
volumes mapping the location of the siblings from your (host) computer to the
container.

Here are two ways you may use a full computing environment, including PACTA
siblings:

* To from with RStudio, ensure your working directory is PACTA_analysis/, then
run `docker-compose up`. RStudio is now available from your a browser at
