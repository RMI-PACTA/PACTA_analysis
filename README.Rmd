...
This repository provides a set of tools, written in R, for implementing the Paris Agreement Capital Transition Assessment ([PACTA](https://www.transitionmonitor.com/)) 
...
Further, the evaluation will require a bunch of package. It is recommended install the package during the first run of the code. (assess approx. 30 minutes for the installation process during the first usage of the code).
...
```
   ...
   - Please define ```data_location_ext``` by copying the full path to the folder, in which you stored the data files (set of rda files) provided Asset Resolution or the 2DII.
