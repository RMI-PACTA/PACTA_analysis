...
revenue_data <- readRDS("C:/Users/jacks/Dropbox (2° Investing)/PortCheck/00_Data/07_AnalysisInputs/2019Q4_250220/revenue_data_member_ticker.rda")
# col_types = "dcdcclcd")

revenue_data <- revenue_data %>% 
  filter(tot_rev > 0) %>% 
  rename(revenue_sector = sector) %>% ungroup()
