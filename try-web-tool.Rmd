...
params:
  example_dataset: !r here::here('sample_files', '20_input_files', 'TestPortfolio_Input.csv')
  project_location_ext: !r here::here()
  data_location_ext: !r fs::path(fs::path_dir(here::here()), 'pacta-data', '2019Q4')
  template_location: !r fs::path(fs::path_dir(here::here()), 'create_interactive_report')
---
...
* To document the repository PACTA_analysis, by incorporating it into the README file.
* To onboard contributors to the PACTA_analysis project.
...
Ensure the following repos are siblings, i.e. they share a parent directory:
...
To make this more portable, overwrite the configutation file with the parameters in this parametrized rmarkdown document.
