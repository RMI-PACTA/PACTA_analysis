...
# availability checks
bonds_available <- c("Bonds_results_company.rds") %in% list.files(results_path)
equity_available <- c("Equity_results_company.rds") %in% list.files(results_path)
portfolio_available <- c(paste0(project_name, "_total_portfolio.rds")) %in% list.files(paste0(proc_input_path, "/"))
# data paths
# inconsisten directory with the check (Meta Investor sub dir)
portfolio_path <- paste0(project_location,"/30_Processed_Inputs/",project_name,"_total_portfolio.rds")
bonds_path <- paste0(project_location,"/40_Results/Meta Investor/Bonds_results_company.rds")
equity_path <- paste0(project_location,"/40_Results/Meta Investor/Equity_results_company.rds")
