test_that("get_security_financial_data() function exists", {
  expect_true(
    class(get_security_financial_data) == "function"
  )
})

test_that("get_security_financial_data() returns a data.frame", {
  skip_check_but_run_test()
  result <- get_security_financial_data(here::here("inst/extdata"))
  expect_true(
    inherits(result, "data.frame")
  )
})

test_that("get_security_financial_data() returns a data.frame with 19 columns", {
  skip_check_but_run_test()
  result <- get_security_financial_data(here::here("inst/extdata"))
  expect_true(
    ncol(result) == 19
...
test_that("get_security_financial_data() returns a data.frame with the proper column names", {
  skip_check_but_run_test()
  result <- get_security_financial_data(here::here("inst/extdata"))
  expect_equal(
    names(result),
...
test_that("get_security_financial_data() returns a data.frame with proper character class columns", {
  skip_check_but_run_test()
  result <- get_security_financial_data(here::here("inst/extdata"))
...
test_that("get_security_financial_data() returns a data.frame with proper date class columns", {
  skip_check_but_run_test()
  result <- get_security_financial_data(here::here("inst/extdata"))
...
test_that("get_security_financial_data() returns a data.frame with proper numeric class columns", {
  skip_check_but_run_test()
  result <- get_security_financial_data(here::here("inst/extdata"))
