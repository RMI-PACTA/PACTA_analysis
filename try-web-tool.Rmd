...
This document aims to provide a reproducible example of the workflow to run PACTA_analysis. It is based on [these instructions by Jacob](https://bit.ly/2RCRJn7). Here are some of the ways you may use this document:
