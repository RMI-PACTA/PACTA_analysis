...
**FIXME: Error at web_tool_script_1.R, create required parent directories**

A number of calls require parent directories, which should be created if they don't exist. You may do that with something like this:
