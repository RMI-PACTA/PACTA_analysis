...
test_that("validate_data_frame_with_more_than_0_rows() can succesffully use an error collector", {
  error_collector <- new_error_collector()
  validate_data_frame_with_more_than_0_rows(data.frame(), error_collector = error_collector)
  expect_false(
