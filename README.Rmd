...
reproducible example of what you can achieve with the code in this repository
...
available at <https://github.com/2DegreesInvesting> and should live side by
side, under the same parent directory. Before any analysis, ensure all siblings
are up to date.
